 ...
 */
public class examQuestion extends javax.swing.JDialog {
   Config config = new Config();
   PreparedStatement pst;
    /**
     * Creates new form NewJDialog
     */
    public examQuestion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void saveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveMouseClicked
        try {
            ...
            String query = "INSERT INTO `examination`(`schl_name`, `Section`, `Subject`, `Class`, `Arm`,`Time`, `Questions`)  VALUES (?,?,?,?,?,?,?)";
