 ...
 */
public class adminexam extends javax.swing.JDialog {
        PreparedStatement pst;
        Config config = new Config();
    /**
     * Creates new form adminexam
     */
    public adminexam(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        sess.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        ...
        script.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        script.setRows(5);
        ...
        quest.setColumns(20);
        quest.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        quest.setRows(5);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(sess, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(31, 31, 31)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel2)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(sess, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        ...
        try {
            ...
            Logger.getLogger(examQuestion.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void transMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_transMouseClicked
        script.append(Name.getText()+"\n"
            +"\n"+sess.getText()+"\n"+"\n"
            +"Subject:"+sub.getText()  +"\n"
            +"Class:"+Grade.getSelectedItem().toString()+Arm.getSelectedItem().toString() +"\n"
            +"Time:"+time.getText()+"\n"
            +"\n"+quest.getText()
    ...
    private void searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchKeyReleased
        if(!search.getText().trim().isEmpty()){
            try {
                ...
                String mrr="SELECT * FROM `examination`WHERE `Class`+`Arm`=? OR`Subject`=? ";
                ...
                if (resultSet.next() !=false) {
                    Name.setText(resultSet.getString("schl_name"));
                    sess.setText(resultSet.getString("session"));
                    sub.setText(resultSet.getString("Subject"));
                    Grade.setSelectedItem(resultSet.getString("Class"));
                    Arm.setSelectedItem(resultSet.getString("Arm"));
                    time.setText(resultSet.getString("Time"));
                    quest.setText(resultSet.getString("Questions"));
