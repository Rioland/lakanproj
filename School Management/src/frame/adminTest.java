 ...
 */
public class adminTest extends javax.swing.JDialog {
            PreparedStatement pst;
    /**
     * Creates new form adminTest
     */
    public adminTest(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchKeyReleased
            ...
            try {
                ...
                String mrr="SELECT * FROM `test_question` WHERE `grade`+`arm`=? OR`subject`=? ";
                ...
                if (resultSet.next() !=false) {
                    Name.setText(resultSet.getString("school_name"));
                    ...
                    quest.setText(resultSet.getString("quest"));
